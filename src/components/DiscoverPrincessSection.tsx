...
const DiscoverPrincessSection = () => {
  ...
  return (
    <section ref={ref} className={`py-16 px-4 bg-primary text-primary-foreground transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
