  ...
  return (
    <section ref={ref} className={`py-16 px-4 bg-gradient-ocean text-white transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <p className="text-xl mb-8">Quiero suscribirme</p>
        ...
        <div className="border-t border-white/30 pt-8 mt-8">
          <p className="text-lg mb-2">¿Eres agente de viajes? <a href="#" className="underline hover:text-accent">Regístrate aquí!</a></p>
          <p className="text-sm opacity-90">Boletín exclusivo para profesionales</p>
        </div>
      </div>
    </section>
  );
